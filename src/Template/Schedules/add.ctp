...
<a href="#panel" class="ui-btn ui-icon-bars ui-btn-icon-left">予定登録</a>
<?= $this->Form->create($schedule,['type' => 'file','data-ajax' => 'false','class'=>'form-container add-schedule','onsubmit'=>'return confirm("登録しますか？")']) ?>
<fieldset>
    ...
    <div class="form-container-fields add-schedule ">
        ...
        <div class="form-container-field">
            <div class="form-container-field-column">
                ...
                <input class="form-container-field-column-input" name="notification_date" type="text" maxlength="255" id="datetimepicker"  /> 
            </div>
        </div>
